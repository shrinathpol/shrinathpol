...
**Embedded & EDA Tools:**
<br/>
<img src="https://img.shields.io/badge/Altium_Designer-A5C854?style=for-the-badge&logo=altiumdesigner&logoColor=white" alt="Altium Designer" />
...
**Hardware & Protocols:**
<br/>
`ESP-IDF` `CMSIS` `I2C` `SPI` `UART` `CAN` `Modbus` `RS485` `Oscilloscopes` `Logic Analyzers`
